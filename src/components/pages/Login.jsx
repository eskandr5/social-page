  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        ...
        <div className="bg-slate-800/80 border border-slate-700 p-4 rounded-xl m-6 text-sm text-slate-300">
          <p className="font-semibold text-amber-400 mb-1">
            Quick Demo (Demo Account):
          </p>
          <p>
          ...
          <div className="mt-3 pt-2 border-t border-slate-700/60 text-xs text-slate-400 flex items-center gap-2">
            <LuMailWarning className="text-amber-400 text-base shrink-0" />
            <span>
              <strong>Note:</strong> The first request may take 30–50 seconds
              due to free tier hosting (Cold Start).
            </span>
          </div>
        </div>
